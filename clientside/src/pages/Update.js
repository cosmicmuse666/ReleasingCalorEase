    ...
    <div className="contact-page">
      <div className={`glass-card`}>
        ...
        <div className="form-group floating">
          <h5>Name</h5>
          <input type="text" defaultValue={pname} onChange={(ev)=>{
        ...
        <div className="form-group floating">
          <h5>Phone</h5>
          <input type="text" defaultValue={phone} onChange={(ev)=>{
        ...
        <div className="form-group">
          ...
          <div className="radio-group">
            <label className="radio-label">
              <input type="radio" name="meal" value="veg" checked={isveg} onChange={(ev)=>{
            ...
            <label className="radio-label">
            <input type="radio" name="meal" value="nonveg" checked={isnonveg} onChange={(ev)=>{
                setMeal(ev.target.value);
                 setVeg(false);
                setNonveg(true);
                setiseverything(false);
            ...
            <label className="radio-label">
            <input type="radio" name="meal" value="none" checked={iseverything} onChange={(ev)=>{
                setMeal(ev.target.value);
                setVeg(false);
                setNonveg(false);
                setiseverything(true);
